...
function gwmDetectType(title) {
  ...
  if (t.includes('court') || t.includes('convict') || t.includes('sentenc') || t.includes('blasphemy') || t.includes('tribunal') || t.includes('confiscat') || t.includes('deregist') || t.includes('restrict') || t.includes('ordered closed') || t.includes('banned')) return 'restriction';
  return 'killing';
}
