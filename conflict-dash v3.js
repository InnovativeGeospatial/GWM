    ...
    .then(function(posts) {
      ...
      posts.forEach(function(post) {
        ...
        if (tickerItems.length < 10) {
          ...
          tickerItems.push("<span class='c-ticker-item'><span class='c-ticker-flag'>" + country.charAt(0).toUpperCase() + country.slice(1) + "</span> — " + shortTitle + " <span class='c-ticker-sev " + sevClass + "'>" + sevLabel + "</span></span>");
        }
      });
